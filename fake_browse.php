...
?></div>
    ...
    for ($i = 1; $i <= $totalPages; $i++) {
        if ($i == $page) {
            ...
            echo '<span style="background-color: #CCC; padding: 1px 4px 1px 4px; border: 1px solid #999; margin-right: 5px;"><a href="browse.php?page=' . $i . '&s=' . $browse_sort . '&t=' . $time . '">' . $i . '</a></span>';
        }
    }
    ?>					
				</div>
